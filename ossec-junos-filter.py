#!/usr/bin/env python
#
#    ossec-junos-filter script for active response for JUNOS devices in ossec
#    Copyright (C) 2019  Pascal FUKS (pascal at starhackademy.net)
#
...
#    1332 Genval
#    Belgium
#    mailto: Pascal at starhackademy.net
...
ossec-junos-filter comes with ABSOLUTELY NO WARRANTY|n \
 (see attached LICENSE file for details).|n \
This is free software, and you are welcome to redistribute it|n \
under certain conditions (see attached LICENSE file for details).|n \
|n \
